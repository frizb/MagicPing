...
def do_one(dest_addr, timeout=1, data="QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ"):
    """
...
def verbose_ping(dest_addr, timeout=2, count=4, data="QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ"):
    """
    Sends one ping to the given "dest_addr" which can be an ip or hostname.
    "timeout" can be any integer or float except negatives and zero.
